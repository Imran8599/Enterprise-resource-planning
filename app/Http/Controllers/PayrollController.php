...
class PayrollController extends Controller
{
    ...
    public function search(Request $request)
    {
        ...
        $rows = Employee::where(['department'=>$request->department])->get();
    ...
    public function payrollGenerate($id)
    {
        ...
        return view('payroll/payroll_generate',compact('row'));
    }
    ...
    public function payrollGenerator(Request $request)
    {
        ...
        if($result)
        {
            alert()->success('Salary Generate successfully.', 'Success');
    ...
    public function payrollPay(Request $request)
    {
        ...
        if($result)
        {
            alert()->success('Salary pay successfully.', 'Success');
            return redirect('payroll');
        }
        else
            return redirect()->back()->with('message-danger','Something is wrong !');
